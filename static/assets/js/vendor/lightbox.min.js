        ...
        function r(s, e) {
            if (!o[s]) {
                if (!i[s]) {
                    ...
                    if (!e && t) return t(s, !0);
                    if (a) return a(s, !0);
                    e = new Error("Cannot find module '" + s + "'");
        ...
        2: [function(e, t, s) {
            ...
            l = this, i = function(e) {
                ...
                l.prototype.init = function() {
                    var s = this,
                        e = (s.s.preload > s.items.length && (s.s.preload = s.items.length), window.location.hash);
                    ...
                    this.s.controls && 1 < this.items.length && (t = '<div class="lg-actions"><div class="lg-prev lg-icon">' + this.s.prevHtml + '</div><div class="lg-next lg-icon">' + this.s.nextHtml + "</div></div>"), ".lg-sub-html" === this.s.appendSubHtmlTo && (l = '<div class="lg-sub-html"></div>'), t = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + e + '</div><div class="lg-toolbar group"><span class="lg-close lg-icon"></span></div>' + t + l + "</div></div>", document.body.insertAdjacentHTML("beforeend", t), this.outer = document.querySelector(".lg-outer"), this.___slide = this.outer.querySelectorAll(".lg-item"), this.s.useLeft ? (h.default.addClass(this.outer, "lg-use-left"), this.s.mode = "lg-slide") : h.default.addClass(this.outer, "lg-use-css3"), i.setTop(), h.default.on(window, "resize.lg orientationchange.lg", function() {
                        setTimeout(function() {
                            i.setTop()
                        }, 100)
                    ...
                    t = this.s.dynamic ? this.s.dynamicEl[t].html : this.items[t].getAttribute("data-html");
                    if (!e && t) return {
                        html5: !0
                    };
                    var t = e.match(/\/\/(?:www\.)?youtu(?:\.be|be\.com)\/(?:watch\?v=|embed\/)?([a-z0-9\-\_\%]+)/i),
                ...
                }, l.prototype.loadContent = function(t, u, s) {
                    function c(e) {
                    ...
                    if (!h.default.hasClass(o.___slide[t], "lg-loaded")) {
                        ...
                        ".lg-sub-html" !== this.s.appendSubHtmlTo && o.addHtml(t), h.default.addClass(o.___slide[t], "lg-loaded")
                    }
                    h.default.on(o.___slide[t].querySelector(".lg-object"), "load.lg error.lg", function() {
                        var e = 0;
                        s && !h.default.hasClass(document.body, "lg-from-hash") && (e = s), setTimeout(function() {
                            h.default.addClass(o.___slide[t], "lg-complete"), h.default.trigger(o.el, "onSlideItemLoad", {
                                index: t,
                                delay: s || 0
                            })
                        }, e)
                    }), n && n.html5 && !d && h.default.addClass(o.___slide[t], "lg-complete"), !0 === u && (h.default.hasClass(o.___slide[t], "lg-complete") ? o.preload(t) : h.default.on(o.___slide[t].querySelector(".lg-object"), "load.lg error.lg", function() {
                        o.preload(t)
                    }))
                    ...
                    if (!o.lGalleryOn || l !== e) {
                        var d = this.___slide.length,
                            u = o.lGalleryOn ? this.s.speed : 0,
                            r = !1,
                            a = !1;
                        if (!o.lgBusy) {
                            if (this.s.download && ((n = o.s.dynamic ? !1 !== o.s.dynamicEl[e].downloadUrl && (o.s.dynamicEl[e].downloadUrl || o.s.dynamicEl[e].src) : "false" !== o.items[e].getAttribute("data-download-url") && (o.items[e].getAttribute("data-download-url") || o.items[e].getAttribute("href") || o.items[e].getAttribute("data-src"))) ? (document.getElementById("lg-download").setAttribute("href", n), h.default.removeClass(o.outer, "lg-hide-download")) : h.default.addClass(o.outer, "lg-hide-download")), h.default.trigger(o.el, "onBeforeSlide", {
                                    prevIndex: l,
                                    index: e,
                                    fromTouch: t,
                                    fromThumb: s
                                ...
                                e < l ? (a = !0, 0 !== e || l !== d - 1 || s || (r = !(a = !1))) : l < e && (r = !0, e !== d - 1 || 0 !== l || s || (r = !(a = !0))), a ? (h.default.addClass(this.___slide[e], "lg-prev-slide"), h.default.addClass(this.___slide[l], "lg-next-slide")) : r && (h.default.addClass(this.___slide[e], "lg-next-slide"), h.default.addClass(this.___slide[l], "lg-prev-slide")), setTimeout(function() {
                    ...
                    t -= e;
                    15 < Math.abs(t) && (h.default.addClass(this.outer, "lg-dragging"), this.setTranslate(this.___slide[this.index], t, 0), this.setTranslate(document.querySelector(".lg-prev-slide"), -this.___slide[this.index].clientWidth + t, 0), this.setTranslate(document.querySelector(".lg-next-slide"), this.___slide[this.index].clientWidth + t, 0))
